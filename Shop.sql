...
INSERT INTO product (product_name, amount, store_id, category_id, supplier_id) VALUES
    ('Конфеты со вкусом Баббл гам', 40, 1, 4, 1),
    ('Шоколад молочный «Cherry Cola»', 14, 1, 3, 1),
    ('Конфеты Одуванчик', 18, 1, 4, 1),
    ('Вафли «Голландские», с карамельной начинкой', 5, 1, 1, 2),
    ('Шоколад молочный с крекером', 7, 1, 3, 2),
    ('Вафельные трубочки «Со вкусом сгущённого молока»', 12, 1, 1, 2),
    ('Мармелад жевательный', 30, 1, 2, 3),
    ('Конфеты mini с фундуком', 10, 1, 4, 3),
    ('Конфеты Creamy', 16, 1, 4, 3),
    ('Конфеты Сибирский сувенир', 11, 1, 4, 4),
    ('Мармелад Сладкая карусель', 21, 1, 2, 4),
    ('Молочный шоколад Аленка', 23, 1, 3, 4),
    ('Milky Way Minis', 15, 1, 4, 5),
    ('Коркунов горький шоколад', 6, 1, 3, 5),
    ('Dove молочный шоколад с изюмом', 20, 1, 3, 5);
